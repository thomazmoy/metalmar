...
class StoreBlog extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'img2'              => 'image|mimes:jpeg,png,jpg,webp|max:256|dimensions:max_width=800,max_height=400',
            'img3'              => 'image|mimes:jpeg,png,jpg,webp|max:256|dimensions:max_width=800,max_height=400',
    ...
    public function messages()
    {
        return [
            ...
            'urltitulo.unique'          => 'Esta URL já existe',
            ...
            'id_categoria.required'     => 'Este campo é obrigatório'
        ];
    }
