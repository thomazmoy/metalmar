            ...
            <div class="card-body p-4">
              <div class="d-flex flex-column h-100">
                <div class="border border-radius-lg p-md-4 p-2 mb-3">
                  ...
                  <h6>{{$quemsomos->tituloum}}</h6>
                  <p>{!!$quemsomos->textoum!!}</p>
                  @if($quemsomos->imgum)
                    <img src='{{ url("storage/{$quemsomos->imgum}") }}' class="border-radius-lg d-lg-block mb-1" width="250px">
                  @endif
                </div>
                <div class="border border-radius-lg p-md-4 p-2 mb-3">
                  <h5 class="font-weight-bolder">2</h5>
                  @if($quemsomos->imgdois)
                    <img src='{{ url("storage/{$quemsomos->imgdois}") }}' class="border-radius-lg d-lg-block mb-1" width="250px">
                  @endif
                </div>
                <div class="border border-radius-lg p-md-4 p-2 mb-3">
                  <h5 class="font-weight-bolder">3</h5>
                  <h6>{{$quemsomos->titulodois}}</h6>
                  <p>{!!$quemsomos->textodois!!}</p>
                  @if($quemsomos->imgtres)
                    <img src='{{ url("storage/{$quemsomos->imgtres}") }}' class="border-radius-lg d-lg-block mb-1" width="250px">
                  @endif
                </div>
                <div class="border border-radius-lg p-md-4 p-2 mb-3">
                  <h5 class="font-weight-bolder">4</h5>
                  <h6>{{$quemsomos->titulotres}}</h6>
                  <p>{!!$quemsomos->textotres!!}</p>
