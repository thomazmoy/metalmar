      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Política de Privacidade</li>
          </ol>
        ...
        <div class="col-lg-12">
          <div class="card mb-4">
            <div class="card-header">
              <h6 class="float-left">Política de Privacidade</h6>
              @if($privacidades->count() < 1)
                <a class="btn bg-gradient-ms mb-0 float-right" href="{{route('privacidade.create')}}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Adicionar Novo</a>
              @else
              @endif
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    @foreach($privacidades as $privacidade)
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">{{$privacidade->titulo}}</h6>
                            </div>
                          </div>
                        </td>
                        <td>
                          <a class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md" href="{{route('privacidade.show', $privacidade->id)}}">
                            <i class="fas fa-eye text-lg opacity-10" aria-hidden="true"></i>
                          </a>
                          <a class="icon icon-shape bg-gradient-warning shadow text-center border-radius-md" href="{{route('privacidade.edit', $privacidade->id)}}">
