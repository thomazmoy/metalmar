        ...
        <div class="col-lg-8 mb-lg-0">
          <div class="card">
            <div class="card-header d-inline-flex pb-0 px-3">
              ...
              <a class="btn bg-gradient-ms ml-auto" href="{{route('galeria.index')}}"><i class="fas fa-angle-left"></i>&nbsp;&nbsp;Voltar</a>
            </div>
            <div class="card-body p-4">
              <div class="d-flex flex-column h-100">
                <h5 class="font-weight-bolder">{{$galerias->titulo}}</h5>
                <h6>{{$galerias->descricao}}</h6>
                @if($galerias->img)
                  <img src='{{ url("storage/{$galerias->img}") }}' class="border-radius-lg" width="250px">
                @endif
              </div>
            </div>
          </div>
