          ...
          <div class="table-responsive p-0">
            <div class="card-body">
              <form role="form text-left">
                ...
                <div class="mb-3">
                  <label>Cargo <span class="obrigatorio">&lowast;</span></label>
                ...
                <div class="mb-3">
                  ...
                  <textarea id="texto" name="texto" class="form-control" value="{{ $depoimentos->texto ?? old('texto')}}">{{ $depoimentos->texto ?? old('texto')}}</textarea>
                  @error('texto')
                    <span class="badge badge-sm mt-1 bg-gradient-warning">{{ $message }}</span>
                  @enderror
                </div>
                <div class="mb-3">
                  ...
                  <div class="d-block py-2">
                    @if($depoimentos->img ?? '')
                      <img src='{{ url("storage/{$depoimentos->img}") }}' class="border-radius-lg" width="100px">
                    @endif
                  </div>
