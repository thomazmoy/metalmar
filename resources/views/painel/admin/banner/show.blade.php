          ...
          <div class="card">
            ...
            <div class="card-body p-4">
              <div class="d-flex flex-column h-100">
                <h5 class="font-weight-bolder">{{$banners->titulo}}</h5>
                <h6 class="mt-2">{{$banners->linkbanner}}</h6>
                @if($banners->imgbanner)
                  <img src='{{ url("storage/{$banners->imgbanner}") }}' class="border-radius-lg mt-2" width="250px">
                @endif
                @if($banners->imgmobile)
                  <img src='{{ url("storage/{$banners->imgmobile}") }}' class="border-radius-lg mt-2" width="250px">
                @endif
              </div>
            </div>
          </div>
