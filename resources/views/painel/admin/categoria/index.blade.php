...
<title>MS System | Categoria</title>
@section('content')
        ...
        <div class="col-lg-12">
          <div class="card mb-4">
            <div class="card-header">
              <h6 class="float-left">Categoria</h6>
                <a class="btn bg-gradient-ms mb-0 float-right" href="{{route('categoria.create')}}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Adicionar Novo</a>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="icon icon-shape bg-gradient-warning shadow text-center border-radius-md" href="{{route('categoria.edit', $categoria->id)}}">
                          <i class="fas fa-pencil-alt text-lg opacity-10" aria-hidden="true" ></i>
                        </a>
                        <a type="submit" class=" icon icon-shape bg-gradient-danger shadow text-center border-radius-md" data-bs-toggle="modal" data-bs-target="#delete" data-orcid='{{$categoria->id}}'>
      ...
      <div class="modal-content">
        ...
        <form action="{{route('categoria.destroy','categoria')}}" method="post">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="categoria_id" id="orc_id" value="">
          </div>
