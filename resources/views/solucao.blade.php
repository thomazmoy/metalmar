  ...
  <section class="w3l-about-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-contact py-5">
      <div class="container text-center py-lg-5 py-md-3">
        <h2>{{ GoogleTranslate::trans('Soluções MetalMar',\App::getLocale()) }}</h2>
      </div>
    </div>
  </section>
                  ...
                  <a href='{{ url("solucoes/{$solucoes->urltitulo}") }}' class="d-block">
                    <div class="row">
                      ...
                      <div class="col-md-6 sobre-p m-auto">
                        <h3 class="title">{{ GoogleTranslate::trans(($solucoes->titulo),\App::getLocale()) }}</h3>
                        <div class="text-justify">
                          {!! GoogleTranslate::trans(($solucoes->descricaodois),\App::getLocale()) !!}
                        </div>
                      </div>
                    </div>
                  </a>
                ...
                <div class="col-lg-4">
                  <div class="grids5-info">
                    ...
                    <div class="blog-info text-center">
                      <h4><a href='{{ url("solucoes/{$solucoes->urltitulo}") }}'>{{ GoogleTranslate::trans(($solucoes->titulo),\App::getLocale()) }}</a></h4>
                      <p>{!! GoogleTranslate::trans(($solucoes->descricao),\App::getLocale()) !!}</p>
                    </div>
                  </div>
                </div>
              @endif
