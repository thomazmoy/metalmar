  ...
  <section class="w3l-about-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-contact py-5">
      <div class="container text-center py-lg-5 py-md-3">
        <h2>{{ GoogleTranslate::trans('Política de Privacidade',\App::getLocale()) }}</h2>
      </div>
    </div>
  </section>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-10 sobre-p m-auto">
              <h2 class="fw-bold">{{ GoogleTranslate::trans(($privacidades->titulo),\App::getLocale()) }}</h2>
              <div class="sobre-p text-justify">
                {!! GoogleTranslate::trans(($privacidades->texto),\App::getLocale()) !!}
              </div>
            </div>
          </div>
        </div>
