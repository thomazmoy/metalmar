  ...
  <script type="application/ld+json">
    {
      ...
      "sameAs": ["https://www.facebook.com/metalmaroficial",
  ...
  <script type="application/ld+json">
    {
      ...
      "image": [
        "https://www.metalmar.ind.br/storage/{{$post->img}}"
       ],
      "datePublished": "{{$post->created_at}}-03:00",
      "dateModified": "{{$post->updated_at}}-03:00",
      "author": [{
          "@type": "Person",
          "name": "Jailson Noronha",
          "url": "{{ url('metalmar-manutencao-industrial-e-naval-em-belem-do-para') }}"
        }]
    }
  </script>
</head>
<body>
  ...
  <section class="w3l-bootstrap-header">
      <h2 class="d-none">{{$post->titulo}}</h2>
      <h3 class="d-none">{{$post->titulo}}</h3>
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="{{ Request::url() == url('/') ? 'nav-link active' : 'nav-link' }}" href='{{ url("") }}'>
                {{ GoogleTranslate::trans('Início',\App::getLocale()) }}
              </a>
            </li>
            <li class="nav-item">
              <a class="{{ Request::url() == url('metalmar-manutencao-industrial-e-naval-em-belem-do-para') ? 'nav-link active' : 'nav-link' }}"
                ...
                {{ GoogleTranslate::trans('Quem Somos',\App::getLocale()) }}
              </a>
            </li>
            <li class="nav-item">
              <a class="{{ Request::url() == url('solucoes-em-manutencao-industrial-e-naval-em-belem-do-para') ? 'nav-link active' : 'nav-link' }}
                ...
                {{ GoogleTranslate::trans('Soluções',\App::getLocale()) }}
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="{{ Request::url() == url('contato-metalmar-manutencao-industrial-e-naval-em-belem-do-para') ? 'nav-link active' : 'nav-link' }}"
                ...
                {{ GoogleTranslate::trans('Contato',\App::getLocale()) }}
              </a>
            </li>
          </ul>
        </div>
  ...
  <!-- Menu Modal -->
  <div class="modal right fade" id="DomainModal" tabindex="-1" role="dialog">
        ...
        <div class="modal-body pt-0">
          <div class="modal__content">
            ...
            <div class="widget-social-icons mt-4">
              <h5 class="widget-title">{{ GoogleTranslate::trans('Onde Estamos?',\App::getLocale()) }}</h5>
              <ul class="icon-rounded address d-grid">
                <li>
                  <p><span class="fa fa-map"></span>
                    <a href="{{$siteconfig->linkendereco}}" target="_blank">
                      {{ GoogleTranslate::trans(($siteconfig->endereco),\App::getLocale()) }}
                    </a>
                  </p>
                </li>
                <li class="mt-2">
            ...
            <div class="widget-social-icons mt-4">
              <h5 class="widget-title">{{ GoogleTranslate::trans('Siga-nos',\App::getLocale()) }}</h5>
            ...
            <div class="widget-social-icons my-4">
              <h5 class="widget-title">{{ GoogleTranslate::trans('Horário de Atendimento',\App::getLocale()) }}</h5>
              <ul class="icon-rounded address d-grid">
                <li class="top_li1 mt-2">
                  <p><span class="fa fa-clock-o"></span>
                    <a href="#horario">{{ GoogleTranslate::trans('Segunda à Sexta 8h - 18h',\App::getLocale()) }}</a>
                  </p>
                  <p><span class="fa fa-clock-o"></span>
                    <a href="#horario">{{ GoogleTranslate::trans('Sábado 8h - 12h',\App::getLocale()) }}</a>
                  </p>
                </li>
              </ul>
            </div>
    ...
    <footer class="footer-28">
        ...
        <div class="container py-3">
          <div class="row footer-top-28 justify-content-center">
            <div class="col-md-4 mt-sm-5 mt-4">
              <h6 class="footer-title-28">{{ GoogleTranslate::trans('Onde Estamos?',\App::getLocale()) }}</h6>
            ...
            <div class="col-md-6 text-center footer-list-28 mt-sm-5 mt-4">
              ...
              <p class="my-3">
                {{ GoogleTranslate::trans(($siteconfig->descricao),\App::getLocale()) }}
              </p>
              <p class="fw-bold mb-3">CNPJ: 20.606.008/0001-03</p>
              <h6 class="footer-title-28 mb-2">
                {{ GoogleTranslate::trans('Siga-nos',\App::getLocale()) }}
              </h6>
              ...
              <a href='{{ url("politica-de-privacidade") }}'><i class="ic fa fa-lock"></i> {{ GoogleTranslate::trans('Política de Privacidade',\App::getLocale()) }}</a>
            </div>
          </div>
        </div>
      </div>
      <div class="midd-footer-28 py-lg-4 py-3 mt-md-5 mt-3">
        <div class="container">
          <div class="row">
            <div class="col-md-10">
              <p class="copy-footer-28 text-md-left text-center">MetalMar &copy;2014-{{ date('Y') }} {{ GoogleTranslate::trans('Todos os direitos reservados.',\App::getLocale()) }} <a class="d-block" href="https://www.moystation.com/" target="_blank">{{ GoogleTranslate::trans('Desenvolvido por',\App::getLocale()) }} <img class="mt-n2" src='{{ url("assets/images/moy.webp") }}' alt="Moy Station"></a></p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="d-md-block d-none">
    ...
    <a href='tel:{{preg_replace("/[^0-9]/", "", $siteconfig->celular)}}' class="btn btn-flutuante btn-flutuante-ligacao d-flex align-items-center justify-content-center" target="_blank">
      <i class="fa fa-mobile mr-2"></i> {{ GoogleTranslate::trans('Celular',\App::getLocale()) }}
    </a>
  </div>
  <div class="row btn-flutuante-2 d-md-none w-100 mx-0">
    <div class="col-6 bg-primary d-flex justify-content-center align-items-center text-center py-2 px-0">
      <a href='tel:{{preg_replace("/[^0-9]/", "", $siteconfig->celular)}}' class="fw-medium text-white" target="_blank"><i class="fa fa-mobile"></i> {{ GoogleTranslate::trans('Celular',\App::getLocale()) }}</a>
    </div>
