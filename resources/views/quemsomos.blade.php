  ...
  <section class="w3l-about-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-contact py-5">
      <div class="container text-center py-lg-5 py-md-3">
        <h2>{{ GoogleTranslate::trans('Quem Somos',\App::getLocale()) }}</h2>
      </div>
    </div>
  </section>
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-lg-6 sobre-p m-auto">
            <h2 class="fw-bold">{{ GoogleTranslate::trans(($quemsomos->titulodois),\App::getLocale()) }}</h2>
            <div class="text-justify">
              {!! GoogleTranslate::trans(($quemsomos->textodois),\App::getLocale()) !!}
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-6 sobre-p mb-4 m-lg-auto">
            <h2 class="fw-bold">{{ GoogleTranslate::trans(($quemsomos->titulotres),\App::getLocale()) }}</h2>
            <div class="text-justify">
              {!! GoogleTranslate::trans(($quemsomos->textotres),\App::getLocale()) !!}
            </div>
          </div>
        </div>
      </div>
